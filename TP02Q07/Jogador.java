class Jogador{
    ...
    public static void log(int comp , long tempo){
        Arq.openWrite("677213_insercao.txt");
    ...
    public static void main(String[] args){
        ...
        Jogador[] jogador = new Jogador[500];
        ...
        for (int i = 1; i < numEntrada; i++){
            ...
            int j = i - 1;
            while ((j >= 0) && (jogador[j].getAnoNascimento() > tmp.getAnoNascimento() || (jogador[j].getAnoNascimento() == tmp.getAnoNascimento() && jogador[j].getNome().compareTo(tmp.getNome()) > 0))) {
                comparacoes++;
